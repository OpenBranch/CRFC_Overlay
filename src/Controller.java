...
public class Controller {
    ...
    public void LScore(ActionEvent actionEvent) throws IOException {
        ...
        FileWriter LScore = new FileWriter("src/TextFiles/LeftScore.txt");
    ...
    public void L6(ActionEvent actionEvent) throws IOException {
        ...
        FileWriter LeftScoreWriter = new FileWriter("src/TextFiles/LeftScore.txt");
    ...
    public void R6(ActionEvent actionEvent) throws IOException {
        ...
        FileWriter RightScoreWriter = new FileWriter("src/TextFiles/RightScore.txt");
    ...
    public void H1(ActionEvent actionEvent) throws IOException {
        FileWriter H1 = new FileWriter("src/TextFiles/Half.txt");
        H1.write("1st Half");
        H1.close();
    }
    ...
    public void H2(ActionEvent actionEvent) throws IOException {
        FileWriter H2 = new FileWriter("src/TextFiles/Half.txt");
        H2.write("2nd Half");
        H2.close();
    }

    public void TimeOut(ActionEvent actionEvent) throws IOException {
        FileWriter MatchETA = new FileWriter("src/TextFiles/ETA.txt");
    ...
    public void News(ActionEvent actionEvent) throws IOException {
        ...
        FileWriter NewsWriter = new FileWriter("src/TextFiles/News.txt");
